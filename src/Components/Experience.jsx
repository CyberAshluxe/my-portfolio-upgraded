...
const timelineData = [
  {
    ...
    date: "2023 - 2024",
    description:
      "Gained hands-on experience in full-stack web development, working on real client projects and learning industry best practices. Collaborated with senior developers on various web applications.",
    highlights: [
  ...
  },
  {
    ...
    date: "2021 - Present",
    description:
      "Pursuing comprehensive education in cybersecurity fundamentals, network security, ethical hacking, and digital forensics. Maintaining strong academic performance while gaining practical skills in security analysis.",
    highlights: [
  ...
  return (
    <section className="experience-section" id="experience">
      <div className="experience-container">
        ...
        >
          My journey of continuous learning and professional growth in
          technology.
        </motion.p>
